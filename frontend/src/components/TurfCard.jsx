...
const TurfCard = (props) => {
  ...
  const ratingBG = () => {
    console.log(rating)
    if(rating === "New") return 'border-[#267E3E] border-[2px] bg-[#267E3E]/50'
  ...
  return (
    <div onClick={handleClick} className="w-[360px] h-[320px] flex flex-col justify-center p-2 bg-white shadow-md rounded-[14px] cursor-pointer">
      ...
      <div className="my-2 flex justify-between items-center antialiased">
        ...
        <div className="flex flex-col items-end font-light">
          <p className={`flex items-center justify-center font-medium text-[14px] text-white px-2 rounded-md ${getbg}`}>{rating}</p>
