...
const TabNavigationBar = () => {
  ...
  const tabs = [
    { name: 'Book Turf', route: '/users/landing', icon: '/logo.svg', iconActive: '/bookturf-logo-active.svg' },
    { name: 'Share n play', route: '/users/shareplay', icon: '/shareplay.svg', iconActive: '/shareplay-active.svg' },
  ];
